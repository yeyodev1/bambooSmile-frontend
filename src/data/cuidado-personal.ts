...
export const cuidadoPersonalData: CuidadoPersonal[] = [
  {
    ...
    precio: '25.75',
    images: [
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755280173/Rasuradora-Negra-1_y7tdei.png',
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755280215/cortador_cbnohh.jpg',
    ],
...
Reutilizable y Reciclable: A diferencia de las afeitadoras desechables, nuestra afeitadora de acero inoxidable es reutilizable y completamente reciclable al final de su vida útil. Al elegir productos reutilizables, contribuyes a reducir la cantidad de residuos plásticos que terminan en los vertederos y en los océanos, protegiendo así el medio ambiente.

Refill de Cuchillas: Nuestra Afeitadora de Acero Inoxidable Metálica ofrece una opción ecológica adicional: la posibilidad de realizar refills de cuchillas. En lugar de desechar toda la afeitadora cuando las cuchillas se desgasten, simplemente puedes reemplazarlas por cuchillas nuevas, prolongando la vida útil de tu afeitadora y reduciendo aún más tu impacto ambiental.

Eleva tu experiencia de afeitado mientras cuidas el medio ambiente con nuestra Afeitadora de Acero Inoxidable Metálica. Diseñada con un enfoque en la sostenibilidad y la durabilidad, es la opción perfecta para aquellos que buscan un afeitado de calidad sin comprometer el cuidado del planeta.`,
  },
  {
    name: 'Afeitadora de Acero Inoxidable Rosada',
    precio: '25.75',
    images: [
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755280261/Rasuradora-Rosa_qnyire.png',
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755280591/rosaaa_sp61n7.jpg',
    ],
    description: `Descubre una forma más sostenible de afeitarte con nuestra Afeitadora de Acero Inoxidable Metálica. Diseñada con un enfoque en la durabilidad, esta afeitadora ofrece un afeitado preciso y cómodo sin comprometer el cuidado del planeta.
...
Eleva tu experiencia de afeitado mientras cuidas el medio ambiente con nuestra Afeitadora de Acero Inoxidable Metálica. Diseñada con un enfoque en la sostenibilidad y la durabilidad, es la opción perfecta para aquellos que buscan un afeitado de calidad sin comprometer el cuidado del planeta.`,
  },
  {
    ...
    precio: '19.78',
    images: [
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755280736/brochas_mlyen7.jpg',
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755280743/brochass_pmoy1i.jpg',
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755280773/brochass_dznght.jpg',
    ],
...
Diseño Versátil: Nuestras brochas vienen en una variedad de formas y tamaños para adaptarse a todas tus necesidades de maquillaje, desde la aplicación de base hasta el contorno y el difuminado de sombras. Ya sea que estés creando un look natural para el día o un look más dramático para la noche, nuestras brochas te ayudarán a lograr resultados impecables.

Suavidad y Precisión: Las cerdas sintéticas suaves y densas de nuestras brochas garantizan una aplicación suave y uniforme de los productos de maquillaje, sin dejar marcas ni irritar la piel. Disfruta de una experiencia de maquillaje de lujo con brochas que miman tu piel y realzan tu belleza natural.

Fácil de Limpiar: Nuestras brochas son fáciles de limpiar y mantener, lo que las hace ideales para el uso diario. Simplemente lava las cerdas con agua tibia y jabón suave, y déjalas secar al aire para mantenerlas en óptimas condiciones.

Compromiso con la Sostenibilidad: Al elegir nuestras Brochas de Bambú para Maquillaje, estás haciendo una elección consciente hacia un futuro más sostenible. Reduce tu huella ecológica sin comprometer la calidad ni el rendimiento, y embellece tu rostro con productos que cuidan tanto de ti como del planeta.
...
Lleva el estilo natural y la portabilidad a tu rutina de peinado con nuestro Cepillo de Bambú Pequeño para Cabello. Disfruta de un cabello suave, manejable y radiante estés donde estés.`,
  },
  {
    ...
    precio: '15.45',
    images: [
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755281247/cepillo-facial_g6ieg9.png',
    ],
...
Exfoliación Suave: Además de limpiar, nuestro cepillo facial también ayuda a exfoliar suavemente la piel, eliminando las células muertas y revelando una tez más suave y radiante. La exfoliación regular puede mejorar la textura de la piel, reducir la apariencia de los poros y promover la renovación celular.

Diseño Ergonómico: El diseño ergonómico del cepillo se adapta cómodamente a la mano, facilitando su uso y maniobrabilidad durante la limpieza facial. Su tamaño compacto lo hace ideal para viajar o para usarlo en casa como parte de tu rutina diaria de cuidado de la piel.

Adecuado para Todo Tipo de Piel: Nuestro cepillo facial es adecuado para todo tipo de piel, incluyendo piel sensible. Sus cerdas suaves y no abrasivas garantizan una limpieza efectiva sin irritación, incluso en las pieles más delicadas.

Modo de Uso: Aplica tu limpiador facial favorito sobre la piel húmeda y utiliza el cepillo facial en movimientos circulares suaves. Enjuaga bien con agua tibia y continúa con tu rutina de cuidado de la piel habitual.

Añade nuestro Cepillo Facial a tu rutina de cuidado de la piel y disfruta de una limpieza profunda y una renovación suave en cada uso. ¡Logra una piel radiante y saludable con esta herramienta imprescindible!`,
  },
  {
...
Cuidado Suave del Cabello: Las cerdas de bambú suaves y flexibles del cepillo desenredan delicadamente el cabello sin causar roturas ni daños. Esto ayuda a mantener la salud del cabello y a reducir la necesidad de productos químicos agresivos.

Masaje del Cuero Cabelludo: Las puntas redondeadas de las cerdas proporcionan un masaje relajante del cuero cabelludo, estimulando la circulación sanguínea y promoviendo un crecimiento capilar saludable.

Diseño Ergonómico: El mango ergonómico del cepillo está diseñado para adaptarse cómodamente a tu mano, facilitando el proceso de cepillado y reduciendo la fatiga durante el uso prolongado.

Transforma tu rutina de cuidado del cabello mientras cuidas el medio ambiente con nuestro Cepillo Grande de Bambú. Es la elección perfecta para aquellos que buscan un cepillo de alta calidad que promueva la salud del cabello y el bienestar del planeta.`,
  },
  {
    name: 'Cepillo para Barba',
    precio: '7.73',
    images: [
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755281630/cepillo-barba_pml4ea.png',
    ],
...
Cerdas de Calidad: Las cerdas suaves y resistentes de nuestro cepillo están diseñadas específicamente para el cuidado de la barba. Ayudan a desenredar el vello facial, distribuir el aceite natural de la piel y darle forma a tu barba con facilidad y precisión.

Material Duradero: Fabricado con materiales de alta calidad, nuestro cepillo para barba está diseñado para resistir el uso diario y perdurar a lo largo del tiempo. Su construcción robusta garantiza un rendimiento duradero y resultados consistentes.

Uso Fácil: Simplemente pasa el cepillo por tu barba en la dirección del crecimiento del vello para desenredar y dar forma. Úsalo a diario como parte de tu rutina de cuidado personal para mantener tu barba suave, ordenada y con un aspecto impecable.
...
Integra nuestro Difusor de Aceites Esenciales en tu rutina diaria y descubre los beneficios transformadores de la aromaterapia. Crea un ambiente de serenidad y armonía en cualquier lugar, en cualquier momento, y sumérgete en una experiencia sensorial que rejuvenece cuerpo, mente y espíritu.`,
  },
  {
    ...
    precio: '3.09',
    images: [
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755281679/Funda-de-Sisal_kqtrtm.png',
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755281765/exfoliador_coed2b.jpg',
    ],
...
Material Biodegradable: El sisal es un material biodegradable y renovable, lo que lo convierte en una opción sostenible para tu rutina de cuidado personal. Al usar nuestro exfoliador de sisal, estás reduciendo tu impacto en el medio ambiente y contribuyendo a la conservación de los recursos naturales.

Estimulación de la Circulación: Al utilizar nuestro exfoliador de sisal regularmente, estimularás la circulación sanguínea de tu piel, lo que puede ayudar a mejorar su apariencia y tono general.

Eleva tu rutina de cuidado personal mientras cuidas el medio ambiente con nuestro Exfoliador de Sisal. Es la elección perfecta para aquellos que buscan una forma natural y sostenible de mantener su piel hermosa y radiante.
...
`,
  },
  {
    ...
    precio: '3.09',
    images: [
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755281809/Jabonera_iivvdv.png',
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755281851/jabonera_tgdgcp.jpg',
    ],
...
Diseño Funcional: Con un diseño elegante y minimalista, nuestra jabonera de bambú complementará cualquier estilo de decoración en tu hogar. Sus ranuras permiten un drenaje eficiente, manteniendo tus jabones secos y prolongando su vida útil. Además, su tamaño compacto la hace perfecta para cualquier espacio, desde el lavamanos hasta la regadera.

Biodegradable y Libre de Plástico: Al optar por nuestra jabonera de bambú, estás contribuyendo a reducir el uso de plásticos y a minimizar tu huella ambiental. Cuando llegue al final de su vida útil, la jabonera se descompondrá naturalmente, sin dejar residuos dañinos para el medio ambiente. Es una elección consciente que ayuda a proteger nuestros océanos y ecosistemas.
...
Eleva tu experiencia de cuidado personal mientras cuidas el medio ambiente con nuestra Jabonera de Bambú Natural. Con su diseño funcional, materiales sostenibles y estética atractiva, es la elección perfecta para aquellos que buscan integrar la sostenibilidad en cada aspecto de su vida diaria.`,
  },
  {
    ...
    precio: '8.76',
    images: [
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755281935/Limpiador-de-lengua_z8vybx.jpg',
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755281963/empaque_mtasbb.jpg',
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755281985/cuarto_qypdqf.jpg',
    ],
...
Diseño Elegante: Con su diseño elegante y natural, nuestra peineta de bambú es un accesorio atemporal que complementa cualquier estilo de cabello y ocasión. Sus dientes suavemente redondeados deslizan suavemente a través de tu cabello, brindando un peinado suave y sin enredos.

Anti-Estática: Gracias a las propiedades naturales del bambú, nuestra peineta ayuda a reducir la estática en tu cabello, dejándolo suave y manejable. Olvídate del cabello encrespado y disfruta de un peinado sedoso y elegante en todo momento.

Multiusos: Nuestra peineta es versátil y adecuada para todo tipo de cabello, desde liso hasta rizado. Úsala para desenredar, peinar o dar forma a tu cabello con facilidad y precisión, creando looks deslumbrantes y naturales.

Sostenibilidad: Al elegir nuestra peineta de bambú, estás optando por una opción respetuosa con el medio ambiente. El bambú es una planta altamente renovable que se regenera rápidamente, lo que la convierte en una alternativa eco-amigable a los plásticos convencionales.

Añade un toque de belleza natural y sostenibilidad a tu colección de accesorios para el cabello con nuestra Peineta de Bambú. Disfruta de un peinado suave y elegante mientras cuidas el medio ambiente.`,
  },
  {
    name: 'Peinilla de bambú',
    precio: '2.78',
    images: ['https://res.cloudinary.com/dpimsaaa4/image/upload/v1755282292/Peine_k3xb81.jpg'],
...
Diseño Ergonómico: El diseño ergonómico de nuestra peinilla garantiza un agarre cómodo y seguro durante el peinado. Sus dientes suaves y redondeados deslizan suavemente a través de tu cabello, sin tirones ni enganches, para un peinado suave y sin esfuerzo.

Anti-Estática: Gracias a las propiedades naturales del bambú, nuestra peinilla ayuda a reducir la estática en tu cabello, dejándolo suave y manejable. Olvídate del cabello encrespado y disfruta de un peinado suave y sedoso en todo momento.

Multiusos: Nuestra peinilla es adecuada para todo tipo de cabello, ya sea liso, ondulado, rizado o grueso. Úsala para desenredar, peinar o dar forma a tu cabello con facilidad y precisión.

Sostenibilidad: Al elegir nuestra peinilla de bambú, estás optando por una opción sostenible y respetuosa con el medio ambiente. El bambú es biodegradable y se regenera rápidamente, lo que lo convierte en una alternativa eco-amigable a los plásticos convencionales.

Añade un toque de naturaleza y sostenibilidad a tu rutina de cuidado capilar con nuestra Peinilla de Bambú. Una opción suave, efectiva y respetuosa con el medio ambiente para un cabello hermoso y saludable.`,
  },
  {
    name: 'Refill de cuchillas',
    precio: '2.99',
    images: ['https://res.cloudinary.com/dpimsaaa4/image/upload/v1755282348/refill_nkjkkb.jpg'],
  ...
  },
  {
    ...
    precio: '22.25',
    images: [
      'https://res.cloudinary.com/dpimsaaa4/image/upload/v1755282386/Rodillo-de-jade_qk1mni.jpg',
    ],
...
Gua-Sha: La Gua-Sha es una herramienta tradicional china que se utiliza para masajear y esculpir el rostro. Hecha de jade, esta herramienta ayuda a liberar la tensión muscular, mejorar la elasticidad de la piel y reducir la apariencia de líneas finas y arrugas, dejando tu piel con un aspecto más firme y tonificado.

Beneficios Antienvejecimiento: Al incorporar regularmente el rodillo de jade y la Gua-Sha en tu rutina de cuidado de la piel, puedes disfrutar de una serie de beneficios antienvejecimiento, como una piel más firme, tonificada y luminosa, así como una reducción en la apariencia de bolsas y ojeras alrededor de los ojos.

Cómo Usar: Después de limpiar y tonificar tu rostro, utiliza el rodillo de jade y la Gua-Sha con movimientos suaves y ascendentes. Puedes aplicar un suero o aceite facial antes de usar las herramientas para mejorar su efectividad y nutrir tu piel aún más.

Eleva tu rutina de cuidado de la piel a un nivel superior con nuestro Kit de Belleza Facial, que incluye un Rodillo de Jade y una Gua-Sha. Descubre los beneficios de la antigua sabiduría china para una piel radiante y juvenil.`,
  },
]
